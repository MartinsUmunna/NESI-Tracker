...
const DieselPricesMap = () => {
  ...
  useEffect(() => {
    ...
    map.current.on('style.load', () => {
      map.current.addSource('diesel-prices', {
        type: 'geojson',
      ...
      // Add hover effect
      map.current.on('mousemove', 'diesel-prices-fill', (e) => {
      ...
      map.current.on('mouseleave', 'diesel-prices-fill', () => {
...
export default DieselPricesMap;