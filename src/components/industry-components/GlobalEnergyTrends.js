  ...
  const energyCards = [
    {
      ...
      description:
        'Each continent has its unique energy profile, with varying degrees of reliance on fossil fuels like coal, oil, and natural gas, as well as renewable sources such as wind, solar, hydroelectric, and geothermal power.',
    ...
    },
    {
      ...
      description:
        'In January 2022, the total yearly energy supply in Africa is approximately 950-1,000 million tons of oil equivalent (Mtoe). This energy supply caters to a continent with a rapidly growing population and varied energy needs.',
    ...
    },
    {
      ...
      description:
        "Africa's energy supply is diversified, encompassing oil, natural gas, hydroelectric power, solar, wind, and biomass. While some countries rely heavily on fossil fuels like oil and gas, others tap into abundant renewable resources like hydropower, solar, and wind.",
    ...
    },
    {
      ...
      description:
        "Nigeria's energy supply is primarily derived from oil and gas, contributing significantly to electricity generation and export. The country is investing in renewable sources like solar and hydroelectric power to diversify its energy mix.",
              ...
              <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                >
                  ...
                  <Box mt={2}>
                    ...
                    <Button variant="outlined" component={Link} to={card.link}>
                      Learn More
                    </Button>
                  </Box>
                </CardContent>
