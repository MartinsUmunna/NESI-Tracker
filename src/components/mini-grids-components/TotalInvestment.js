  ...
  const optionscolumnchart = {
    ...
    dataLabels: {
      ...
      formatter: function (val) {
        return '₦' + val + 'm'; // Corrected concatenation
      },
      style: {
        fontSize: '10px',
    ...
    title: { // This is part of the overall options object
      text: 'Yearly Trend',
      align: 'center',
      style: {
        fontSize: '14px',
    ...
    <BlankCard>
      <CardContent sx={{ p: '25px' }}>
        ...
        <Grid container spacing={0} mt={2}>
          <Grid item xs={12}>
            <Typography variant="h4" mt={3} fontWeight={600}>₦18m</Typography>
