...
import StateMapboxFinancialBS from '../../../components/distribution-components/by-state-chart-cards/statemapbox-bs';
import StateCostBreakdownFinancialBS from '../../../components/distribution-components/by-state-chart-cards/statecost-breakdown-bs';
import StateFilter from 'src/layouts/full/shared/breadcrumb/StateFilter'
import TariffFinancialBS from '../../../components/distribution-components/by-state-chart-cards/tarrifs-bs';
import OpexBreakdownFinancialBS from '../../../components/distribution-components/by-state-chart-cards/opex-breakdown-bs';
const BCrumb = [
  {
    to: '/',
    title: 'Home',
